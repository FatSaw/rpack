...
import me.bomb.rpack.http.ServerManager;
...
public final class ResourceManager {
	...
	public ResourceManager(boolean servercache, byte[] salt, boolean waitacception, final Collection<InetAddress> onlineips, final InetAddress ip, final int port, final int backlog, final int timeout, final ServerSocketFactory serverfactory, final short connectcount) {
	 ...
	 * @return true if removed
	 */
	public boolean removeCache(String id) {
		if(resources == null) {
			return false;
		}
